...
if ($IrstDriverPath -or $AutoDownloadIrst) {
    Add-DriverToImage -MountPath "$mainOSDrive\scratchdir" -DriverPath $IrstDriverPath -ImageName "install.wim" -AutoDownload:$AutoDownloadIrst -DownloadUrl $IrstDriverUrl
}
...
if ($IrstDriverPath -or $AutoDownloadIrst) {
    Add-DriverToImage -MountPath "$mainOSDrive\scratchdir" -DriverPath $IrstDriverPath -ImageName "boot.wim (Windows Setup)" -AutoDownload:$AutoDownloadIrst -DownloadUrl $IrstDriverUrl
}
