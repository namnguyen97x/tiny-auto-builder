...
Dismount-WindowsImageWithRetry -Path "$ScratchDisk\scratchdir" -Save
...
try {
    $oscdimgOutput = & "$OSCDIMG" '-m' '-o' '-u2' '-udfver102' "-bootdata:2#p0,e,b$ScratchDisk\tiny11\boot\etfsboot.com#pEF,e,b$ScratchDisk\tiny11\efi\microsoft\boot\efisys.bin" "$ScratchDisk\tiny11" $isoPath 2>&1
